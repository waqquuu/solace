...
const COA_DATABASE: CoaRecord[] = [
  ...
  {
    lot: "GLP-2406R",
    product: "GLP-3 (RT) research vial",
    slug: "glp-3-rt",
    format: "injectable",
    method: "HPLC + MS",
    purity: "99.2%",
  ...
  {
    lot: "WOLV-2404S",
    product: "Wolverine Blend research vial",
  ...
  {
    lot: "BPCS-2404S",
    product: "BPC-157 sublingual strips",
  ...
  {
    lot: "TA1-2404S",
    product: "Thymosin Alpha-1 sublingual strips",
  ...
  {
    lot: "CJC-2403S",
    product: "CJC-1295 + Ipamorelin sublingual strips",
  ...
  {
    lot: "PT141-2403S",
    product: "PT-141 sublingual strips",
